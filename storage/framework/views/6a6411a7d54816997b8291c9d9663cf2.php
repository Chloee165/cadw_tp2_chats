...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['titre' => 'Le saviez vous?']));
...
foreach (array_filter((['titre' => 'Le saviez vous?']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
    ...
    <main>
        <div class="container-fluid vh-100 d-flex justify-content-center align-items-center">
            <div class="fact-card text-center p-4 rounded shadow-sm">
                <p class="lead"><?php echo e($fait->contenu); ?></p>
            </div>
        </div>
    </main>
...
<?php endif; ?>
<?php /**PATH C:\Users\clola\Downloads\fait_chats\fait_chats\resources\views/faits/show.blade.php ENDPATH**/ ?>